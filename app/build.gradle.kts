...
android {
    namespace = "lk.kdu.ac.mc.sumudustodolist"
    compileSdk = 34

    defaultConfig {
        applicationId = "lk.kdu.ac.mc.sumudustodolist"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.room:room-ktx:$roomVersion") // For Flow support
    // Hilt (Optional but highly recommended for DI)
